...
import static org.apache.ignite.spi.tracing.OperationType.JOB;
import static org.apache.ignite.spi.tracing.OperationType.QUERY;
import static org.apache.ignite.spi.tracing.OperationType.QUERY_READS;
import static org.apache.ignite.spi.tracing.OperationType.TASK;
import static org.apache.ignite.spi.tracing.OperationType.TX_COMMIT;
import static org.apache.ignite.spi.tracing.OperationType.TX_ROLLBACK;
import static org.apache.ignite.spi.tracing.OperationType.cacheRecordSize;
import static org.apache.ignite.spi.tracing.OperationType.jobRecordSize;
import static org.apache.ignite.spi.tracing.OperationType.queryReadsRecordSize;
import static org.apache.ignite.spi.tracing.OperationType.queryRecordSize;
import static org.apache.ignite.spi.tracing.OperationType.taskRecordSize;
import static org.apache.ignite.spi.tracing.OperationType.transactionRecordSize;
